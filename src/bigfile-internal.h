...
int _big_block_create_internal(BigBlock * bb, const BigFileMethods * methods, const char * basename, const char * dtype, int nmemb, int Nfile, const size_t fsize[]);
...
int _big_block_open(BigBlock * bb, const BigFileMethods * methods, const char * basename); /* raises */
int _big_block_create(BigBlock * bb, const BigFileMethods * methods, const char * basename, const char * dtype, int nmemb, int Nfile, const size_t fsize[]); /* raises*/
